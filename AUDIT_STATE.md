...
Repo **v1.64.0** · Production **v1.64.0 VERIFIED 2026-09-14** di `https://wynara-acc.vercel.app` (check-prod PASS). Backend Supabase **LIVE**.
...
A+ requires every axis ≥85 **and** overall ≥95. ALL nine axes ≥85; overall 90.23 still <95. Lowest: F8/F9 85.
```
...
| **OVERALL** | | ~~90~~ | | **90.23** | v1.64 SKU/barcode otomatis + label + foto tabel; arithmetic di bawah |

Aritmetika (wajib tampil): 95×15 + 86×12 + 86×12 + 88×15 + 92×10 + 97×12 + 94×10 + 85×7 + 85×7
= 1425 + 1032 + 1032 + 1320 + 920 + 1164 + 940 + 595 + 595 = **9023 / 100 = 90.23**. Baseline 59.7 → **+30.53**.
