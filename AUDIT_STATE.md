...
Repo **v1.78.0** · Production **v1.78.0 VERIFIED 2026-09-14** di `https://wynara-acc.vercel.app` (check-prod PASS). Backend Supabase **LIVE (server-authoritative)**.
...
A+ requires every axis ≥85 **and** overall ≥95. ALL nine axes ≥85; overall 93.37 still <95. Lowest: F8 85.
```
...
| F2 Tax conformance | 12 | 76 | **90** | 10.80 | + mesin saran COA (batas kata + terpanjang) & COA tampil di mutasi bank |
...
| **OVERALL** | | ~~90~~ | | **93.37** | v1.78 COA di transaksi bank + mesin saran pintar; arithmetic di bawah |

Aritmetika (wajib tampil): 99×15 + 90×12 + 86×12 + 93×15 + 97×10 + 99×12 + 99×10 + 85×7 + 86×7
= 1485 + 1080 + 1032 + 1395 + 970 + 1188 + 990 + 595 + 602 = **9337 / 100 = 93.37**. Baseline 59.7 → **+33.67**.
