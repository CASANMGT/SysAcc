...
Repo **v1.67.0** · Production **v1.67.0 VERIFIED 2026-09-14** di `https://wynara-acc.vercel.app` (check-prod PASS). Backend Supabase **LIVE**.
...
A+ requires every axis ≥85 **and** overall ≥95. ALL nine axes ≥85; overall 90.80 still <95. Lowest: F8/F9 85.
```
...
| F5 Reporting | 10 | 94 | **95** | 9.50 | + Halaman 🛒 Penjualan khusus (KPI, grafik harian, terlaris, per-produk, metode bayar, struk) |
...
| **OVERALL** | | ~~90~~ | | **90.80** | v1.67 halaman Penjualan khusus; arithmetic di bawah |

Aritmetika (wajib tampil): 96×15 + 86×12 + 86×12 + 88×15 + 95×10 + 98×12 + 94×10 + 85×7 + 85×7
= 1440 + 1032 + 1032 + 1320 + 950 + 1176 + 940 + 595 + 595 = **9080 / 100 = 90.80**. Baseline 59.7 → **+31.10**.
