...
Repo **v1.75.0** · Production **v1.75.0 VERIFIED 2026-09-14** di `https://wynara-acc.vercel.app` (check-prod PASS). Backend Supabase **LIVE (server-authoritative)**.
...
A+ requires every axis ≥85 **and** overall ≥95. ALL nine axes ≥85; overall 92.88 still <95. Lowest: F8/F9 85.
```
...
| F7 Cognitive load | 10 | 80 | **96** | 9.60 | + modal Aturan Bank + preset sekali-klik (jauh lebih mudah dipakai) |
...
| **OVERALL** | | ~~90~~ | | **92.88** | v1.75 modal Aturan Bank + COA e-wallet + preset; arithmetic di bawah |

Aritmetika (wajib tampil): 99×15 + 89×12 + 86×12 + 93×15 + 97×10 + 99×12 + 96×10 + 85×7 + 85×7
= 1485 + 1068 + 1032 + 1395 + 970 + 1188 + 960 + 595 + 595 = **9288 / 100 = 92.88**. Baseline 59.7 → **+33.18**.
