...
describe('aksesibilitas F9 (boot enhancements)', () => {
  ...
  it('menu restruktur: Kas & Bank, Pembelian, Biaya (+Aset, Daftar Akun)', () => {
    ...
    ['kasReconMatchAllBtn', 'kasReconBankSelect', 'kasReconEndBal', 'kasReconDiff', 'bankRuleKeyword', 'bankRuleCode', 'bankRuleAddBtn', 'bankRulesList'].forEach(id => expect(document.getElementById(id)).toBeTruthy());
  });
